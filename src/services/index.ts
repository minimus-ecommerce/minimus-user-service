...
import type { UserCreatePayload, UserUpdatePayload } from "../types.js";
...
export async function createUser(userDetails: UserCreatePayload) {
  const query = {
